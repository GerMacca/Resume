...
const pt = {
  ...
  activity: {
    ...
    subtitle: "{count} contribuições no último ano",
    less: "Menos",
    more: "Mais",
  ...
  lab: {
    ...
    ninaHint: "Digite o pangrama para colorir as letras",
  ...
  terminal: {
    ...
    aboutText:
      "Germano Maccagnan — dev desktop de dia, dev web à noite. Caxias do Sul, RS.",
    navigating: "navegando para",
    downloading: "baixando currículo...",
    opening: "abrindo",
    langChanged:
      "idioma alterado para inglês... just kidding, agora é english!",
  },
};
...
const en: typeof pt = {
  ...
  activity: {
    ...
    subtitle: "{count} contributions in the last year",
    less: "Less",
    more: "More",
  ...
  lab: {
    ...
    ninaHint: "Type the pangram to color the letters",
  ...
  terminal: {
    ...
    aboutText:
      "Germano Maccagnan — desktop dev by day, web dev by night. Caxias do Sul, Brazil.",
    navigating: "navigating to",
    downloading: "downloading resume...",
    opening: "opening",
    langChanged:
      "language switched to portuguese... brincadeira, agora é português!",
  },
};
